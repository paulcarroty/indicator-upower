    ...
    def get_config_device(self):
        ...
        with open(self.config_file) as f:
            ...
            try:
                ...
                logger.warning('Failed to load the config file: {}'.format(str(sys.exc_info()[1])))
            if self.charging_enabled_FILE == 1:
