...
cp -v $(dirname "${BASH_SOURCE[0]}")/indicator-upower.service /home/phablet/.config/systemd/user/
cp -v $(dirname "${BASH_SOURCE[0]}")/upower.indicator /home/phablet/.local/share/unity/indicators/
